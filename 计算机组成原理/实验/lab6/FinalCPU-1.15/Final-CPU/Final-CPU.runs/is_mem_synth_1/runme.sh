...
HD_PWD='D:/vivado/projects/Final-CPU/Final-CPU.runs/is_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log is_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source is_mem.tcl
