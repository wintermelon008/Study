...
HD_PWD='D:/vivado/projects/Final-CPU/Final-CPU.runs/user_stack_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_stack.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_stack.tcl
