...
HD_PWD='D:/vivado/projects/Final-CPU/Final-CPU.runs/interrupt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interrupt.tcl
