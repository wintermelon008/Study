...
HD_PWD='D:/vivado/projects/Final-CPU/Final-CPU.runs/div_unsigned_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_unsigned.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_unsigned.tcl
