...
HD_PWD='D:/vivado/projects/Final-CPU/Final-CPU.runs/FADD_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FADD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FADD.tcl
